 ...
 *
 */
package net.mcreator.spookygame;
...
@Mod("spookygame")
public class SpookygameMod {
	public static final Logger LOGGER = LogManager.getLogger(SpookygameMod.class);
	public static final String MODID = "spookygame";

	public SpookygameMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		SpookygameModBlocks.REGISTRY.register(bus);
